...
export default function NewProject({ onAdd, onCancel }) {
    ...
    function handleSave() {
        ...
        if (entertedTitle.trim() === '' || entertedDescription.trim() === '' || entertedDueDate.trim() === '') {
            modal.current.open();
            return;
        }
    ...
    return (
        <>
            <Modal ref={modal} buttonCaption="Okay">
                {/** 
                 * Styling is the same with {@link NoProjectSelected}. 
                 * Should be better to create seperate reusable componenets but we don't need it now. 
                 */}
