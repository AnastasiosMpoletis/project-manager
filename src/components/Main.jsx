...
export default function Main({ projectState, selectedProject,
    onProjectStateChange, onAddNewProject, onDeleteSelectedProject, onAddNewTaskToSelectedProject, onDeleteTask }) {
    return (
        <>
